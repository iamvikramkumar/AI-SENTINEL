    ...
    if request.method == "POST":
        if 'file' in request.files:
            ...
            if file_extension == 'jpg':
                ...
                model = YOLO("../yolo_weights/crash_det_2.pt")
                ...
                out = cv2.VideoWriter('crash_det_output.mp4', fourcc, 30.0, (frame_width, frame_height))
                ...
                while cap.isOpened():
                    ...
                    # do ../yolo_weights/crash_det_2.pt detection on the frame here
